...
public class IntegerAggregator implements Aggregator {
    ...
    private DbIterator min(List<Tuple> tuples, Type groupByFieldType, int groupByField, int aggregateField) {
    ...
    private DbIterator max(List<Tuple> tuples, Type groupByFieldType, int groupByField, int aggregateField) {
        if (tuples == null || tuples.isEmpty()) {
            throw new NoSuchElementException("No tuple can be processed");
        }
    ...
    private DbIterator avg(List<Tuple> tuples, Type groupByFieldType, int groupByField, int aggregateField) {
        if (tuples == null || tuples.isEmpty()) {
            throw new NoSuchElementException("No tuple can be processed");
        }
    ...
    private DbIterator count(List<Tuple> tuples, Type groupByFieldType, int groupByField) {
        if (tuples == null || tuples.isEmpty()) {
            throw new NoSuchElementException("No tuple can be processed");
        }
    ...
    private DbIterator sum(List<Tuple> tuples, Type groupByFieldType, int groupByField, int aggregateField) {
        if (tuples == null || tuples.isEmpty()) {
            throw new NoSuchElementException("No tuple can be processed");
        }
